...
module.exports = defineConfig({
  testDir: __dirname,
  testMatch: ['browser.spec.cjs', 'next.spec.cjs', 'bundle.spec.cjs', 'accessibility.spec.cjs', 'usability.spec.cjs', 'custom-elements.spec.cjs', 'packaged-components.spec.cjs', 'default-packages.spec.cjs', 'visual.spec.cjs'],
  timeout: 30000,
