...
PUBLIC_FILES = (
    ...
    'downloads/timvw-0.9.0.zip', 'ACCESSIBILITY_REVIEW.md',
    'components/accordion.js', 'components/buttons.js', 'components/charts.js', 'components/commands.js', 'components/details.js', 'components/dialogs.js', 'components/feedback.js', 'components/files.js', 'components/forms.js', 'components/layout.js', 'components/navigation.js', 'components/overlays.js', 'components/package.js', 'components/page.js', 'components/people.js', 'components/select.js', 'components/tables.js', 'components/tabs.js', 'components/theme.js', 'components/workflows.js',
